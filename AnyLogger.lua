...
local lstEventNamesByID = GetGlobalNamesByID(
...
--   LogBase(lstEventNamesByID[eventid], ...)
--end
local function LogAnyEvent(eventid, ...)
...
function AnyLogger:Initialize()
   --AnyLoggerSavedVariablesV2 = ZO_SavedVars:NewAccountWide("AnyLoggerSavedVariablesV2", 1, nil, {})
